...
#   1, "S23LCS", 746, 10.5, NA, 2, 4, 0, 73, 78.33, # Quaking aspen (Woodall example)
#   2, "S23LCS", 746, 4.5, NA, 2, 4, 0, 73, 78.33, # Quaking aspen (Woodall example)
#   3, "S23LCS", 66, 4.9, 20, 2, 4, 0, NA, NA, # Rocky Mountain juniper
#   4, "S23LCS", 746, 10.5, NA, 2, 4, 3,  73, 78.33 # (Domke example)
#   )
