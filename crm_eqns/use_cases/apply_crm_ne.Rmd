...
# tree <- tribble(
#   ~EXAMPLE, ~CONFIG_ID, ~SPCD, ~DIA, ~HT, ~STATUSCD, ~TREECLCD, ~DECAYCD, ~BOLE_HT, ~PCT_ROTTEN,
#   1, "S24", 12, 10.5, NA, 2, 4, 0, 40, 15, # Quaking aspen (Woodall example)
#   2, "S24", 12, 10.5, NA, 2, 4, 3,  40, 15, # (Domke example)
#   2, "S24", 10, 10.5, NA, 2, 4, 3,  40, 15, 
#   2, "S24", 90, 4.2, NA, 2, 4, 3,  30, 15 
#   )
